...
[Files]
Source: x64\Debug\*;  DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs; Check: IsWin64;
...
Filename: "{reg:HKLM64\SOFTWARE\Microsoft\.NETFramework,InstallRoot}\v4.0.30319\RegAsm.exe"; Parameters:  """{app}\SW2URDF.dll"" ""/unregister"""; StatusMsg: Unregistering controls ...; RunOnceId: "UnregisterSW2URDF"; Check: IsWin64; Languages:
